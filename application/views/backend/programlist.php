            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">Data Program Assessment</a>
                    </li>
                </ul>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption">Data Daftar Program Assessment
                        ...
                        <div class="portlet-body">
                            <div class="table-container" id="doclist">
                                ...
                                <!-- <div class="table-actions-wrapper">
                                 ...
                                 <table class="table table-striped table-bordered table-advance dataTable table-hover" id="listprogram" data-url="<?php echo base_url('backend/reportprogramlist/'); ?>">
                                <thead>
