                        ...
                        <div class="portlet-body">
                            <?php if($login_type == 3 ) : ?>
                                <table class="table table-bordered ">
                                    ...
                                    <tbody>
                                        <?php if ($report_comp = get_report_comp_report($row->id_assessment,'all',$row->id)) {
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="portlet box blue-steel">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form role="form" class="addreportfinal" id="addreportfinal<?php echo $row->seat_number; ?>" action="<?php echo base_url()?>backend/addreportfinalact" method="POST" enctype="multipart/form-data" class="form">
                                    ...
                                    <label class="control-label">CATATAN</label>
                                        <?php 
                                            if ( $row->status < 2) {
                                                ...
                                                echo '<textarea rows="20" class="form-control" name="notes" placeholder="'.$row->notes.'" value="'.$row->notes.'" style="resize: vertical;" readonly>'.$row->notes.'</textarea> ';
                                            }
                                            ?>
                                        </div>
                                    </div>
