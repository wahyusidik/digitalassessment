	...
	<div class="col-md-12">
		...
		<div class="portlet">
			<div class="portlet-title">
            	<div class="caption">Edit Kompetensi
                </div>
            </div>
			<div class="portlet-body form">
				<div class="table-container" id="">
					...
					<form role="form" id="editcompetence" action="<?php echo base_url()?>backend/editcompetenceact" method="POST" enctype="multipart/form-data" class="form-horizontal">
						<div class="form-body">
                            <div id="message_error" class="alert alert-danger display-hide">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" name="name" placeholder="Nama Kompetensi" value="<?php echo $competence->name?>">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label popovers" >Nama Pendek</label>
								<div class="col-md-8">
									<input type="text" class="form-control" name="name_short" placeholder="Nama Pendek Kompetensi" value="<?php echo $competence->name_short?>">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3">Deskripsi</label>
								<div class="col-md-8">
									<textarea class="wysihtml5 form-control" rows="6" name="desc"><?php echo $competence->definition; ?></textarea>
								</div>
							</div>
							<h3 class="form-section">Level Profisiensi Kompetensi</h3>
							<?php 
							$levels = $this->model_member->get_competence_level($competence->id);
							if ($levels){
								foreach ($levels as $level ) {?>
									<input type="hidden" name="levelid[]" value="<?php echo $level->id;?>">
									<div class="form-group">
										<label class="col-md-3 control-label">Level <?php echo $level->level;?></label>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Nama Level</label>
										<div class="col-md-8">
											<input type="text" class="form-control" name="levelname[<?php echo $level->level;?>]" placeholder="Nama Level" value="<?php echo $level->title;?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Deskripsi</label>
										<div class="col-md-8">
											<textarea class="wysihtml5 form-control" rows="6" name="leveldesc[<?php echo $level->level;?>]"><?php echo $level->definition;?></textarea>
										</div>
									</div>
							<?php }
							} else{
