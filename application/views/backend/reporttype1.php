<div class="col-md-12">
    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">Form Observasi
            </div>
            <div class="tools">
                    ...
                    if ( $assessment->status < 1) {
                        ...
                        if ($part) {
                            foreach ($part as $p) {
                                ...
                                echo '<textarea rows="2" class="form-control" name="note_assesse_other['.$p->seat_number.']" placeholder="Catatan untuk assesse '.$p->seat_number.'" style="resize: vertical;" required></textarea>'; 
                            }
                        }
                    } else {
