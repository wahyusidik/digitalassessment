...
|--------------------------------------------------------------------------
*/
define('TITLE',             "Digital Assetsment Center | ");
// define('COMPANY_NAME',      "Mirazenway");
...
define('BASE_URL',          SCHEMA . $_SERVER["SERVER_NAME"] . '/dac/');
...
define('BOOTSTRAP_PATH',    BASE_URL . 'assets/plugins/bootstrap/');
